...
const ImageSubtitleGrid = ({ imageSrc, subtitle1, subtitle2,fontSize }) => (
  <Grid container spacing={1} sx={{ backgroundColor: 'rgba(51,51,50,255)', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)', borderRadius: '8px', marginBottom: '10px' , width:"80%",paddingBottom:"3px" }}>
...
const images = [
  ...
  { url: 'assets/images/serviceCenter-3789e366.png', caption: '24/7 Customer service' },
...
const AccountMain = ({ children }) => {
  ...
  const options = [
    { label: 'Notifications', icon: 'assets/images/download (6).png', subLabel: null, onClick: () => navigate('/messages') },
    { label: 'Gifts', icon: 'assets/images/download (7).png', color: "gold", subLabel: null, onClick: () => navigate('/coupen-user') },
    { label: 'Game Statistics', icon: 'assets/images/download (8).png', subLabel: null, },
    { label: 'Language', icon: 'assets/images/languageIcon-634b6df2.png', subLabel: 'English', onClick: () => navigate('/language') },
    ...
    <div>
      <Mobile>
        ...
        <Box
           ...
           position="relative"
            sx={{
              backgroundColor: 'rgba(36,36,36,255)', // Base background color
              overflowY: 'scroll',
              overflowX: 'hidden',
              '&::-webkit-scrollbar': {
                width: '1px',
        ...
        >
          <Box flexGrow={1} >
            <Grid
              container
              sx={{
                backgroundImage: 'linear-gradient(90deg,rgba(237,209,136,255) 0%, rgba(203,157,75,255) 100%)', // Base grid background color
      ...
      <IconButton onClick={handleCopy}>
        <FileCopyIcon sx={{ color: "white",width:"15px",height:"15px" }} />
            ...
            <div style={{ position: 'relative', marginTop: '-20%', zIndex: 1 }}>
              <Grid container sx={{
                backgroundColor: 'rgba(77,77,76,255)',
                padding: '20px',
                borderRadius: '12px',
...
<MenuList sx={{ backgroundColor: 'rgba(51,51,50,255)', borderRadius: '8px' ,   marginLeft: 'auto', marginRight: 'auto', width:"90%", boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)', }}>
...
{options.map((option, index) => [
    ...
    <Grid container spacing={2} mt={2} sx={{ backgroundColor: 'rgba(51,51,50,255)', borderRadius: '8px', padding: '10px',  marginLeft: 'auto',
